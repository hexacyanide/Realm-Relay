...
public final class RealmRelay {
	...
	public static void main(String[] args) {
		...
		if (RealmRelay.instance.listenSocket.start()) {
		    RealmRelay.echo("Realm Relay listener started");
		    ...
		    RealmRelay.echo("Realm Relay listener problem. Make sure there are no instances of Realm Relay already running.");
		}
	}
